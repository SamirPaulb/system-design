<sup> **Disclaimer**: This webpage is a modification of [@karanpratapsingh](https://github.com/karanpratapsingh)'s [system-design](https://github.com/karanpratapsingh/system-design) repository with [CC BY-NC-ND 4.0](https://github.com/karanpratapsingh/system-design/commits/main/LICENSE) [license](https://drive.google.com/file/d/1XNunkcoiM90bUjI3LbM8giyVPWc8xVNE/view). I have created this repository only for my personal learning purpose. I do not hold any right to distribute or share the content. Please contact the original creator for any permissions.</sup>
...
![osi-model](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/osi-model/osi-model.png){:loading="lazy"}
...
![tcp](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/tcp-and-udp/tcp.png){:loading="lazy"}
...
![udp](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/tcp-and-udp/udp.png){:loading="lazy"}
...
![how-dns-works](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/domain-name-system/how-dns-works.png){:loading="lazy"}
...
![dns-query-types](https://raw.githubusercontent.com/SamirPaulb/assets/main/Iterative-and-recursive-dns-query-diagram.png){:loading="lazy"}
...
![load-balancing](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/load-balancing/load-balancer.png){:loading="lazy"}

For additional scalability and redundancy, we can try to load balance at each layer of our system:

![load-balancing-layers](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/load-balancing/load-balancer-layers.png){:loading="lazy"}
...
![redundant-load-balancing](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/load-balancing/redundant-load-balancer.png){:loading="lazy"}
...
![cluster](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/clustering/cluster.png){:loading="lazy"}
...
![active-active](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/clustering/active-active.png){:loading="lazy"}
...
![active-passive](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/clustering/active-passive.png){:loading="lazy"}
...
![caching](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/caching/caching.png){:loading="lazy"}
...
![write-through-cache](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/caching/write-through-cache.png){:loading="lazy"}
...
![write-around-cache](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/caching/write-around-cache.png){:loading="lazy"}
...
![write-back-cache](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/caching/write-back-cache.png){:loading="lazy"}
...
![distributed-cache](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/caching/distributed-cache.png){:loading="lazy"}
...
![global-cache](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/caching/global-cache.png){:loading="lazy"}
...
![cdn-map](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/content-delivery-network/cdn-map.png){:loading="lazy"}
...
![cdn](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/content-delivery-network/cdn.png){:loading="lazy"}
...
![forward-proxy](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/proxy/forward-proxy.png){:loading="lazy"}
...
![reverse-proxy](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/proxy/reverse-proxy.png){:loading="lazy"}
...
![scalability](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-I/scalability/scalability.png){:loading="lazy"}
...
![database-types](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/databases-and-dbms/database-types.png){:loading="lazy"}
...
![master-slave-replication](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/database-replication/master-slave-replication.png){:loading="lazy"}
...
![master-master-replication](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/database-replication/master-master-replication.png){:loading="lazy"}
...
![indexes](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/indexes/indexes.png){:loading="lazy"}
...
![dense-index](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/indexes/dense-index.png){:loading="lazy"}
...
![sparse-index](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/indexes/sparse-index.png){:loading="lazy"}
...
NoSQL databases are great for distributed networks. They allow for **horizontal scaling**, and they can quickly scale across multiple nodes. When deciding which NoSQL database to use, it’s important to keep the CAP theorem in mind. NoSQL databases can be classified based on the two CAP features they support.
 ...
 <p align="center">
    <img loading="lazy" src="https://raw.githubusercontent.com/SamirPaulb/assets/main/cap_theorem-system-design-samirpaul1.jpeg" alt="cap-theorem">
 </p>
...
![pacelc-theorem](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/pacelc-theorem/pacelc-theorem.png){:loading="lazy"}
...
![transaction-states](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/transactions/transaction-states.png){:loading="lazy"}
...
![two-phase-commit](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/distributed-transactions/two-phase-commit.png){:loading="lazy"}
...
![three-phase-commit](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/distributed-transactions/three-phase-commit.png){:loading="lazy"}
...
![sagas](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/distributed-transactions/sagas.png){:loading="lazy"}
...
![sharding](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/sharding/sharding.png){:loading="lazy"}
...
![simple-hashing](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/consistent-hashing/simple-hashing.png){:loading="lazy"}
...
![consistent-hashing](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/consistent-hashing/consistent-hashing.png){:loading="lazy"}
...
![virtual-nodes](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/consistent-hashing/virtual-nodes.png){:loading="lazy"}
...
![database-federation](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-II/database-federation/database-federation.png){:loading="lazy"}
...
![n-tier-architecture](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/n-tier-architecture/n-tier-architecture.png){:loading="lazy"}
...
![message-broker](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/message-brokers/message-broker.png){:loading="lazy"}
...
![message-queue](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/message-queues/message-queue.png){:loading="lazy"}
...
![publish-subscribe](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/publish-subscribe/publish-subscribe.png){:loading="lazy"}
...
![enterprise-service-bus](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/enterprise-service-bus/enterprise-service-bus.png){:loading="lazy"}
...
![monolith](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/monoliths-microservices/monolith.png){:loading="lazy"}
...
![microservices](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/monoliths-microservices/microservices.png){:loading="lazy"}
...
![architecture-range](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/monoliths-microservices/architecture-range.png){:loading="lazy"}
...
![event-driven-architecture](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/event-driven-architecture/event-driven-architecture.png){:loading="lazy"}
...
![event-sourcing](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/event-sourcing/event-sourcing.png){:loading="lazy"}
...
![command-and-query-responsibility-segregation](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/command-and-query-responsibility-segregation/command-and-query-responsibility-segregation.png){:loading="lazy"}
...
![api-gateway](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/api-gateway/api-gateway.png){:loading="lazy"}
...
![backend-for-frontend](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/api-gateway/backend-for-frontend.png){:loading="lazy"}
...
![long-polling](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/long-polling-websockets-server-sent-events/long-polling.png){:loading="lazy"}
...
![websockets](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/long-polling-websockets-server-sent-events/websockets.png){:loading="lazy"}
...
![server-sent-events](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-III/long-polling-websockets-server-sent-events/server-sent-events.png){:loading="lazy"}
...
![geohashing](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/geohashing-and-quadtrees/geohashing.png){:loading="lazy"}
...
![quadtree](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/geohashing-and-quadtrees/quadtree.png){:loading="lazy"}
...
![quadtree-subdivision](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/geohashing-and-quadtrees/quadtree-subdivision.png){:loading="lazy"}
...
![circuit-breaker](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/circuit-breaker/circuit-breaker.png){:loading="lazy"}
...
![rate-limiting](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/rate-limiting/rate-limiting.png){:loading="lazy"}
...
![client-side-service-discovery](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/service-discovery/client-side-service-discovery.png){:loading="lazy"}
...
![server-side-service-discovery](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/service-discovery/server-side-service-discovery.png){:loading="lazy"}
...
![disaster-recovery](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/disaster-recovery/disaster-recovery.png){:loading="lazy"}
...
![virtualization-vs-containerization](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/virtual-machines-and-containers/virtualization-vs-containerization.png){:loading="lazy"}
...
![oauth2](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/oauth2-and-openid-connect/oauth2.png){:loading="lazy"}
...
![sso](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-IV/single-sign-on/sso.png){:loading="lazy"}
...
![url-shortener-datamodel](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/url-shortener/url-shortener-datamodel.png){:loading="lazy"}
...
![url-shortener-basic-design](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/url-shortener/url-shortener-basic-design.png){:loading="lazy"}
...
![url-shortener-advanced-design](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/url-shortener/url-shortener-advanced-design.png){:loading="lazy"}
...
![whatsapp-datamodel](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/whatsapp/whatsapp-datamodel.png){:loading="lazy"}
...
![whatsapp-basic-design](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/whatsapp/whatsapp-basic-design.png){:loading="lazy"}
...
![whatsapp-advanced-design](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/whatsapp/whatsapp-advanced-design.png){:loading="lazy"}
...
![twitter-datamodel](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/twitter/twitter-datamodel.png){:loading="lazy"}
...
![newsfeed-pull-model](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/twitter/newsfeed-pull-model.png){:loading="lazy"}
...
![newsfeed-push-model](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/twitter/newsfeed-push-model.png){:loading="lazy"}
...
![twitter-advanced-design](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/twitter/twitter-advanced-design.png){:loading="lazy"}
...
![netflix-datamodel](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/netflix/netflix-datamodel.png){:loading="lazy"}
...
![video-processing-pipeline](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/netflix/video-processing-pipeline.png){:loading="lazy"}
...
![file-chunking](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/netflix/file-chunking.png){:loading="lazy"}
...
![netflix-advanced-design](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/netflix/netflix-advanced-design.png){:loading="lazy"}
...
![uber-datamodel](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/uber/uber-datamodel.png){:loading="lazy"}
...
![uber-working](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/uber/uber-working.png){:loading="lazy"}
...
![uber-advanced-design](https://raw.githubusercontent.com/SamirPaul1/portfolio/master/public/static/courses/system-design/chapter-V/uber/uber-advanced-design.png){:loading="lazy"}
